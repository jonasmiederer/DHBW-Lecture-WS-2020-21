...
Falls die Formel keine Lösungen im rellen Zahlenraum liefert soll eine Fehlermeldung ausgegeben werden
"""
...
Die Lösungsformel soll nur angewendet werden, falls Lösungen im reellen Zahlenraum existieren.
Dies ist der Fall, wenn der Term unter der Wurzel positiv ist
"""

if (b**2 - 4*a*c) < 0:
    print("Es existiert keine Lösung im reellen Zahlenraum")
